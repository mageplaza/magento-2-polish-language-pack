...
![Polish language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-polish-language-pack:dev-master avada/module-proofo
...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/pl_pl/`

See this screenshot:

![Polish pack](https://cdn3.mageplaza.com/media/general/language-pack.png)
...
## 3. How to Active the Polish language pack 
